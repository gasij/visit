    ...
    <section id="about" className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto w-full min-w-0">
      <div className="grid lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-20 items-start">
        <div className="space-y-12">
          ...
          <Reveal delay={0.2}>
            <div className="text-2xl sm:text-3xl md:text-4xl leading-snug">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Reveal delay={0.3} width="100%">
              <div className="bg-white text-black p-5 sm:p-8 rounded-2xl sm:rounded-[3rem] h-full">
            ...
            <Reveal delay={0.4} width="100%">
              <div className="bg-zinc-900 border border-zinc-800 p-5 sm:p-8 rounded-2xl sm:rounded-[3rem] relative group h-full">
            ...
            <Reveal delay={0.5} width="100%">
              <div className="bg-zinc-900 border border-zinc-800 p-5 sm:p-8 rounded-2xl sm:rounded-[3rem] md:row-span-2 h-full">
            ...
            <Reveal delay={0.6} width="100%">
              <div className="bg-zinc-900 border border-zinc-800 p-5 sm:p-8 rounded-2xl sm:rounded-[3rem] h-full">
